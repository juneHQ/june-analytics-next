...
function getCookieOptions() {
    ...
    var domain = tld_1.tld(window.location.href);
    cookieOptions = {
        expires: 31536000000,
        secure: false,
        path: '/'
...
function referrerId(query, ctx, disablePersistance) {
    var storage = new user_1.UniversalStorage(disablePersistance ? [] : ['cookie'], user_1.getAvailableStorageOptions(getCookieOptions()));
