...
function loadLegacySettings(writeKey, cdnURL) {
    var baseUrl = cdnURL !== null && cdnURL !== void 0 ? cdnURL : parse_cdn_1.getCDN();
    return fetch_1.fetch(baseUrl + "/v1/projects/" + writeKey + "/settings")
        .then(function (res) {
        if (!res.ok) {
...
function flushPreBuffer(analytics, buffer) {
    buffer.push.apply(buffer, snippet_1.popSnippetWindowBuffer());
    buffer_1.flushSetAnonymousID(analytics, buffer);
    buffer_1.flushOn(analytics, buffer);
}
/**
        ...
        return tslib_1.__generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    buffer.push.apply(buffer, snippet_1.popSnippetWindowBuffer());
                    return [4 /*yield*/, buffer_1.flushAddSourceMiddleware(analytics, buffer)];
                case 1:
                    _a.sent();
                    buffer.push.apply(buffer, snippet_1.popSnippetWindowBuffer());
                    buffer_1.flushAnalyticsCallsInNewTask(analytics, buffer);
        ...
        return tslib_1.__generator(this, function (_g) {
            switch (_g.label) {
                ...
                case 11:
                    ...
                    return [4 /*yield*/, remote_loader_1.remoteLoader(legacySettings, analytics.integrations, mergedSettings, options.obfuscate, tsubMiddleware)["catch"](function () { return []; })];
                case 12:
        ...
        return tslib_1.__generator(this, function (_j) {
            switch (_j.label) {
                case 0:
                    ...
                    if (settings.cdnURL)
                        parse_cdn_1.setGlobalCDNUrl(settings.cdnURL);
                ...
                case 3:
                    ...
                    inspector_1.attachInspector(analytics);
...
var AnalyticsBrowser = /** @class */ (function (_super) {
    ...
    function AnalyticsBrowser() {
        var _this = this;
        var _a = create_deferred_1.createDeferred(), loadStart = _a.promise, resolveLoadStart = _a.resolve;
